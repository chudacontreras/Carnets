 ...
 */
public class CarnetsView extends FrameView {
    
    public CarnetsView(SingleFrameApplication app) {
        super(app);
    ...
    public void newRecord() {
        carnets.Carnet c = new carnets.Carnet();
    ...
    public void deleteRecord() {
        ...
        List<carnets.Carnet> toRemove = new ArrayList<carnets.Carnet>(selected.length);
        for (int idx=0; idx<selected.length; idx++) {
            carnets.Carnet c = list.get(masterTable.convertRowIndexToModel(selected[idx]));
            toRemove.add(c);
    ...
    private class SaveTask extends Task {
        ...
        @Override protected Void doInBackground() {
            try {
                ...
                rex.printStackTrace();
                entityManager.getTransaction().begin();
                List<carnets.Carnet> merged = new ArrayList<carnets.Carnet>(list.size());
                for (carnets.Carnet c : list) {
    ...
    public void showAboutBox() {
        if (aboutBox == null) {
            JFrame mainFrame = CarnetsApp.getApplication().getMainFrame();
            aboutBox = new CarnetsAboutBox(mainFrame);
            aboutBox.setLocationRelativeTo(mainFrame);
        }
        CarnetsApp.getApplication().show(aboutBox);
    }
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(carnets.CarnetsApp.class).getContext().getResourceMap(CarnetsView.class);
        ...
        org.jdesktop.swingbinding.JTableBinding.ColumnBinding columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${departamento}"));
        ...
        departamentoLabel.setText(resourceMap.getString("departamentoLabel.text")); // NOI18N
        departamentoLabel.setName("departamentoLabel"); // NOI18N
        ...
        departamentoField.setName("departamentoField"); // NOI18N

        org.jdesktop.beansbinding.Binding binding = org.jdesktop.beansbinding.Bindings.createAutoBinding(org.jdesktop.beansbinding.AutoBinding.UpdateStrategy.READ_WRITE, masterTable, org.jdesktop.beansbinding.ELProperty.create("${selectedElement.departamento}"), departamentoField, org.jdesktop.beansbinding.BeanProperty.create("text"));
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(carnets.CarnetsApp.class).getContext().getActionMap(CarnetsView.class, this);
        ...
        mainPanelLayout.setHorizontalGroup(
            ...
            .addGroup(mainPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(mainPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(departamentoField, javax.swing.GroupLayout.DEFAULT_SIZE, 315, Short.MAX_VALUE)
    ...
    private java.util.List<carnets.Carnet> list;
